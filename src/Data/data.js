  ...
  export const mealData = [
    ...
    export const faqs = [
      ...
      },
      {
        ...
        ans:`Delivery fee varies from city to city and is applicable if order value is below a certain amount. Additionally, certain restaurants might have fixed delivery fees. Delivery fee (if any) is specified on the 'Review Order' page. `
      },
      {
        id: 5,
      ...
      },
      {
        ...
        ans:'In order to provide all customers with a great selection and to ensure on time delivery of your meal, we reserve the right to limit the quantities depending on supply.'
      },
      {
        id: 7,
        question:'Can I order in advance?',
        ans:'We currently do not support this functionality. All our orders are placed and executed on-demand.'
      },
    ...
    export const legal = [
      ...
      },
      {
        ...
        ans:`1. Cancellation Policy:
        (a) Clearly state the conditions under which users can cancel their orders or subscriptions.
        (b) Specify any deadlines or time frames for cancellations.

        2. Refund Eligibility:        
        (a)  Outline the criteria for users to be eligible for a refund.
        (b)   Mention if there are specific circumstances or conditions that warrant a refund.

        3. Refund Process:       
        (a)  Explain the step-by-step process users need to follow to request a refund.
        (b)   Provide details on where and how users should submit refund requests.

        4. Refund Timeframe:       
        (a)  Communicate the expected timeframe for processing refunds.
        (b)   If there are any delays or specific periods for processing, make this information clear.
        `
      },
      {
        id: 4,
    ...
    export const partner = [
      ...
      {
        id: 1,
        question:'I want to partner my restaurant with You ',
        ans:'We value our customer’s time and hence moved away from a single customer care number to a comprehensive chat-based support system for quick and easy resolution. You no longer have to go through the maze of an IVRS call support. Just search for your issue in the help section on this page and initiate a chat with us'
      ...
      },
      {
        ...
        ans:'You can connect with Partner Support on 080-67466777/68179777 or write to partnersuport@swiggy.in'
      },
      {
        id: 6,
