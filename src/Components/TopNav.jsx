...
const TopNav = () => {
    ...
    // }
  return (
   <div className={`fixed w-full z-10 ${scrolling ? 'bg-[#24262b] text-white' : ''}`}>
        ...
        <div onClick={()=>{setSideNav(!sidenav)}} className='flex items-center'>   
            ...
            <div className='hidden lg:flex items-center bg-gray-200 h-[40px] rounded-full p-1 text-[14px] cursor-pointer'>
                <p className='bg-orange-700 text-white rounded-full w-[55px]  pt-2 ml-[-4px] mt-3 text-center font-bold h-10 '> <Link to='/homee' className='no-underline text-white'>Free</Link></p>
                <p className='pt-[14px] px-2 font-bold h-8 w-18'> <Link to='/delivery' className='no-underline text-black'>Delivery</Link></p> 
            </div>
        ...
        <div className='flex hover:text-orange-700  mr-[-140px] cursor-pointer' onClick={signup}>
         ...
         <div 
            ...
            <AiOutlineClose onClick={()=>{setSideNav(!sidenav)}} className={`absolute right-4 top-4 cursor-pointer ${scrolling ? ' text-black' : ''}`} size={25} />
            <h2 className={`text-2xl p-4 ${scrolling ? ' text-black' : ''}`}>Yum <span className='text-orange-700 font-bold'>Eats</span></h2>
                <nav>
                    <ul className='flex flex-col p-4 text-gray-900'>

                        <li className='text-xl py-3 mt-[-35px] flex cursor-pointer hover:bg-[#778899] hover:text-white hover:rounded-md'>
                            < GiHouse size={25} className='mr-4 text-white bg-black rounded-full '/>
                            <Link className='text-gray-900 no-underline' to='/homee'>Home</Link>
                        ...
                        <li className='text-xl py-3 flex cursor-pointer hover:bg-[#778899] hover:text-white hover:rounded-md'>
                            ...
                            <Link className='text-gray-900 no-underline' to='/delivery'>Devilery</Link>
                        </li>
                        <li className='text-xl py-3 flex cursor-pointer hover:bg-[#778899] hover:text-white hover:rounded-md'>
                            < MdOutlineFavorite size={25} className='mr-4 text-white bg-black rounded-full'/>
                            <Link className='text-gray-900 no-underline' to='/favoritepage'>My Favorite</Link>
                        </li>
                        <li className='text-xl py-3 flex cursor-pointer hover:bg-[#778899] hover:text-white hover:rounded-md'>
                        ...
                        <li className='text-xl py-3 flex cursor-pointer hover:bg-[#778899] hover:text-white hover:rounded-md'>
                            ...
                            <Link className='text-gray-900 no-underline' to='/contactus'>Contact Us</Link>
                           
                        </li>
                        <li className='text-xl py-3 flex cursor-pointer hover:bg-[#778899] hover:text-white hover:rounded-md'>
                            <MdHelp size={25} className='mr-4 text-white bg-black rounded-full'/>
                            <Link className='text-gray-900 no-underline' to='/help'>Help & Support</Link>
